  ...
  return (
    <main className="">
      ...
      <section className='bg-Light_Lightness_white h-[674px]  flex items-center'>
        <RowSection>
          <>
            <div className='flex flex-col align-start w-1/2 pl-[150px]'>
              <div className='leading-10 flex flex-col gap-3'>
                <h1 className='text-4x1 text-Light_Lightness_3 text-5xl mt-[27px] mb-[21px] w-2/4'>
            ...
            <div className='w-1/2 flex justify-start relative'>
              <Image className='w-4/5 object-fit h-full absolute top-0 bottom-0 right-[auto]' src={ImageLaptop} alt='image laptop' width={579} height={447}/>
            </div>
          </>
        </RowSection>
      </section>
      ...
      <section className='bg-Light_Lightness_white  pt-[128px] pb-[96px]'> 
        <RowSection>
          <>
            ...
            <div className='w-1/2 px-[32px] flex justify-start relative'>
              <div>
                <FeatureText
                ...
                <ButtonPrimary
                  ...
                  borderRadius
                  fill
                  content='Create a Quiz for Free'
                  bg='bg-Light_Lightness_Purple_0'
                  fontSize='text-[16px]'
                />
              </div>
      ...
      <section className='bg-Light_Lightness_white pr-[32px] py-[96px]'>
        <RowSection>
          <>
            <div className='w-1/2 px-[32px] flex justify-end relative'>
              <div>
                <FeatureText
            ...
            <div className='w-1/2 flex justify-start relative'>
              <Image className='ml-[52px]' src={ImagePublishEasy} alt='image' width={536} height={536}/>
            </div>
          </>
        </RowSection>
      </section>
